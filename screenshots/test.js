...
(async () => {
  ...
  await page.goto('https://8080-bdeebaffedbdaffaeebbbbabacedfecdcaceefaffcabd.ide.exam.ly');
  ...
  await page1.goto('https://8081-bdeebaffedbdaffaeebbbbabacedfecdcaceefaffcabd.ide.exam.ly');
