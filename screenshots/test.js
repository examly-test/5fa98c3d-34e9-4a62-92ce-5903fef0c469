...
(async () => {
  ...
  await page.goto('https://8080-bdeebaffedbdaffaeebbbbabacedfeeafbcecdcaeae.ide.exam.ly');
  ...
  await page1.goto('https://8081-bdeebaffedbdaffaeebbbbabacedfeeafbcecdcaeae.ide.exam.ly');
